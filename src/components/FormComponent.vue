<template>
    <div id="form-bodyfit">
        <p class="fit-advisor-intro text-center" id="intro1">
            <span id="mark1">To get a size recommendation,</span> <br /><span
                id="mark2"
        ...
        countryval: function() {
            if (this.container.countrycheck == false) {
                ...
                this.heightconvert(
                    ...
                    localStorage.getItem("inch"),
                    parseFloat(localStorage.getItem("cm")).toFixed(0),
                    false
                );
        ...
        validateWeight: function() {
            ...
            if (this.container.form.weight > 500) {
                ...
                localStorage.setItem(
                    "weight",
                    parseFloat(this.container.form.weight).toFixed(0)
                );
            }
        },
            ...
            if (c == true) {
                ...
                if (isNaN(cm)) {
                    ...
                    if (inch >= 5) {
                        ...
                        this.container.form.heightinch = parseInt(
                            Math.floor(inch)
                        );
                    }
